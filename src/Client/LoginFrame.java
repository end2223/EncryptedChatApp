    ...
    public LoginFrame() {
        ...
        login.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String response = Login(txtUsername.getText(), (new MD5()).md5(String.copyValueOf(txtPassword.getPassword())));
...
//                    username = txtUsername.getText();
                    ...
                    EventQueue.invokeLater(new Runnable() {
                        public void run() {
                            try {
                                ChatFrame frame = new ChatFrame(user, dis, dos);
                                frame.setVisible(true);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (action == JOptionPane.OK_OPTION) {
                    if (String.copyValueOf(confirm.getPassword()).equals(String.copyValueOf(txtPassword.getPassword()))) {
                        String response = Signup(txtUsername.getText(), 
                                (new MD5()).md5(String.copyValueOf(txtPassword.getPassword())));
